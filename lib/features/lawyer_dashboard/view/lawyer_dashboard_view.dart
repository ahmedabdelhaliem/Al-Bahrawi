    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          DefaultButtonWidget(
            onPressed: () {
              context.push(AppRouters.lawyerCheckout);
            },
          ...
          Row(
            ...
            children: [
              Text(
                ...
                style: getRegularStyle(color: ColorManager.blackText, fontSize: 14.sp),
              ),
              Container(
              ...
              Expanded(
                child: DefaultButtonWidget(
                  onPressed: () {
                    context.push(
                      AppRouters.chatView,
                      extra: {'chatId': index + 1, 'supplierName': 'عميل القضية ${index + 1}'},
                    );
                  },
