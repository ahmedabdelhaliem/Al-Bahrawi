        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildSectionTitle(AppStrings.today.tr()),
                _buildNotificationCard(
                  title: AppStrings.requestAnswered.tr(),
                  desc: AppStrings.requestAnsweredDesc.tr(),
                ...
                _buildNotificationCard(
                  title: AppStrings.requestUpdate.tr(),
                  desc: AppStrings.requestUpdateDesc.tr(),
                ...
                _buildSectionTitle(AppStrings.yesterday.tr()),
                _buildNotificationCard(
                  title: AppStrings.newRequest.tr(),
                  desc: AppStrings.newRequestDesc.tr(),
                ...
                SizedBox(height: 10.h),
                _buildSectionTitle(AppStrings.mockDate.tr()),
                _buildNotificationCard(
                  title: AppStrings.welcome.tr(),
                  desc: AppStrings.welcomeNotificationDesc.tr(),
                  icon: Icons.grid_view_rounded,
                  iconColor: ColorManager.grey,
                  bgColor: ColorManager.grey.withValues(alpha: 0.05),
                  onTap: () => context.push(AppRouters.myCases),
