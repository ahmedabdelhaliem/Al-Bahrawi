...
import 'package:base_project/featuers/contact_us/view/contact_us_view.dart';
import 'package:base_project/featuers/privacy_policy/view/privacy_policy_view.dart';
import 'package:base_project/featuers/profile/cubit/logout_cubit.dart';
import 'package:base_project/featuers/profile/cubit/profile_cubit.dart';
import 'package:base_project/featuers/profile/view/edit_profile_view.dart';
          ...
          BlocConsumer<LogoutCubit, BaseState<BaseModel>>(
            listener: (context, state) async {
              if (state.status == Status.success) {
                ...
                if (mounted) {
                  context.go(AppRouters.login,extra: {
                    "pageIndex": 3
                  });
                }
            ...
            builder: (context, state) {
              final isLoggedIn = instance<AppPreferences>().getToken().isNotEmpty;
