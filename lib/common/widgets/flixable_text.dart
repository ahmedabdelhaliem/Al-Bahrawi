          ...
          children: [
            ...
            if(isTextBigger(text))
              InkWell(onTap: () => setState((){
                isExpand = !isExpand;
              }),child: Text(isTextBigger(text) && !isExpand ? AppStrings.showMore.tr() : AppStrings.showLess.tr(), style: TextStyle(color: ColorManager.green,fontSize: 12.sp,fontWeight: FontWeight.w400))),
          ],
        ),
      ),
    );
